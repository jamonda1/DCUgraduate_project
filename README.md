...
>**기대 효과**
>
>&nbsp;사용자가 기록한 여행기는 타인이 자유롭게 조회 및 공유가 가능합니다. 이를 통해 타인이 느낀 여행 소감을 볼 수 있고, 개시글 공유를 통해 국내외의 새로운 여행지가 발굴될 수 있습니다. 또한 공유 목적이 아니더라도 지금까지의 여정을 추억하기 위해 사용하는 것도 가능해 여행 산업에 기여할 수 있습니다.
